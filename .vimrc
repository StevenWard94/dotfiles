...
" General Settings \begin
  ...
  " Setting up directories \begin
    ...
    function! s:GenerateBackupDirs() abort
      let l:bak_dir_path = "/home/steven/.archived/bak.d"
      let l:cur_dir_path = expand("%:p:h")

      if isdirectory(l:cur_dir_path . "/bak.d")
        let l:bak_dir_path = l:cur_dir_path."/bak.d,".l:bak_dir_path
      elseif isdirectory(l:bak_dir_path . "/" . expand("%:p:h:t"))
        let l:bak_dir_path = l:bak_dir_path."/".expand("%:p:h:t").",".l:bak_dir_path
      endif
      unlet l:cur_dir_path
      return l:bak_dir_path
    endfunction
